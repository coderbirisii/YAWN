...
using YAWN.Helpers;
using YAWN.Properties;
using static YAWN.Helpers.Login;
using static YAWN.Helpers.ValApi;

namespace YAWN.Views;
...
public partial class Settings : UserControl
{
    ...
    private async void Button_Click1Async(object sender, RoutedEventArgs e)
    {
        ...
        AutoUpdater.Start(
            "https://raw.githubusercontent.com/coderbirisii/YAWN/main/YAWN/VersionInfo.xml"
        );
    ...
    private static Task<string> GetLatestVersionAsync()
    {
        ...
        xml.Load("https://raw.githubusercontent.com/coderbirisii/YAWN/main/YAWN/VersionInfo.xml");
